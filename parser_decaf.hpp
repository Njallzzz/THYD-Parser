...
/**
 ** \file /cygdrive/c/Users/Muninn/Desktop/Programming/THYD-Parser/cmake-build-debug/../parser_decaf.hpp
 ** Define the yy::parser class.
 */

// C++ LALR(1) parser skeleton written by Akim Demaille.

#ifndef YY_YY_CYGDRIVE_C_USERS_MUNINN_DESKTOP_PROGRAMMING_THYD_PARSER_CMAKE_BUILD_DEBUG_PARSER_DECAF_HPP_INCLUDED
# define YY_YY_CYGDRIVE_C_USERS_MUNINN_DESKTOP_PROGRAMMING_THYD_PARSER_CMAKE_BUILD_DEBUG_PARSER_DECAF_HPP_INCLUDED
...
#line 50 "/cygdrive/c/Users/Muninn/Desktop/Programming/THYD-Parser/cmake-build-debug/../parser_decaf.hpp" // lalr1.cc:377
...
namespace yy {
#line 127 "/cygdrive/c/Users/Muninn/Desktop/Programming/THYD-Parser/cmake-build-debug/../parser_decaf.hpp" // lalr1.cc:377
  ...
  public:
    ...
    union union_type
    {
      ...
      // variable
      char dummy2[sizeof(VariableExprNode*)];

      // variable_declarations
      char dummy3[sizeof(std::list<VariableDeclarationNode*>*)];

      // variable_list
      char dummy4[sizeof(std::list<VariableExprNode*>*)];
  ...
  basic_symbol (typename Base::kind_type t, const std::list<VariableExprNode*>* v, const location_type& l);
    ...
    , location (other.location)
  {
      switch (other.type_get ())
    {
      ...
      case 44: // variable_list
        value.copy< std::list<VariableExprNode*>* > (other.value);
        break;
    ...
    , location (l)
  {
      ...
      switch (this->type_get ())
    {
      ...
      case 44: // variable_list
        value.copy< std::list<VariableExprNode*>* > (v);
        break;
  ...
  template <typename Base>
  parser_decaf::basic_symbol<Base>::basic_symbol (typename Base::kind_type t, const std::list<VariableExprNode*>* v, const location_type& l)
    : Base (t)
    , value (v)
    , location (l)
  {}
  ...
  parser_decaf::basic_symbol<Base>::clear ()
  {
   ...
   default:
    ...
    switch (yytype)
    {
      ...
      case 44: // variable_list
        value.template destroy< std::list<VariableExprNode*>* > ();
        break;
  ...
  parser_decaf::basic_symbol<Base>::move (basic_symbol& s)
  {
      ...
      switch (this->type_get ())
    {
      ...
      case 44: // variable_list
        value.move< std::list<VariableExprNode*>* > (s.value);
        break;
  ...
  parser_decaf::symbol_type
  parser_decaf::make_Number (const std::string& v, const location_type& l)
  {
...
#line 1425 "/cygdrive/c/Users/Muninn/Desktop/Programming/THYD-Parser/cmake-build-debug/../parser_decaf.hpp" // lalr1.cc:377




#endif // !YY_YY_CYGDRIVE_C_USERS_MUNINN_DESKTOP_PROGRAMMING_THYD_PARSER_CMAKE_BUILD_DEBUG_PARSER_DECAF_HPP_INCLUDED
